...
<head>
    <meta charset="UTF-8">
    <title>Browse | Library Management System</title>
            ...
            <div class="search-result-display displaytable">
                <table>
                    ...
                    <tr>
                        ...
                        <td><a href="user?page=getbook&id=<%=student.getId()%>" class="infolink"><%=student.getTitle()%>
                        </a></td>
                        <td><a href="user?page=getbookauthor&query=<%=student.getAuthor()%>"
                               class="infolink"><%=student.getAuthor()%>
                        </a></td>
                        <td><a href="user?page=getgenre&query=<%=student.getGenre()%>"
                               class="infolink"><%=student.getGenre()%>
                        </a></td>
